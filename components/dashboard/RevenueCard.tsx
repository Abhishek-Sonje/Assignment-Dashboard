...
export default function RevenueCard() {
  return (
    <div className="col-span-12 xl:col-span-8 bg-white rounded-3xl p-6 shadow-soft relative overflow-hidden group">
      <div className="flex justify-between items-start mb-2">
         <div>
            <h3 className="text-sm font-semibold text-gray-500 mb-1">Revenue</h3>
            <div className="flex items-baseline gap-3">
                <span className="text-4xl font-extrabold text-gray-900 tracking-tight">{REVENUE_STATS.total}</span>
                <div className="flex items-center gap-2">
                    <span className="bg-[#E11D48] text-white text-xs font-bold px-2 py-1 rounded-full flex items-center">
                        <ArrowUpRight className="w-3 h-3 mr-0.5" /> {REVENUE_STATS.change}
                    </span>
                    <span className="bg-[#E11D48] text-white text-xs font-bold px-2 py-1 rounded-full">
                        {REVENUE_STATS.amount}
                    </span>
                </div>
            </div>
            <p className="text-gray-400 text-xs mt-2 font-medium">
                {REVENUE_STATS.comparison} <span className="text-gray-300 mx-1">•</span> {REVENUE_STATS.period}
            </p>
         </div>
         ...
         <div className="flex gap-4">
             {/* Top Sales */}
             <div className="bg-gray-50 rounded-2xl p-4 w-40 flex flex-col justify-between hover:bg-gray-100 transition-colors cursor-pointer">
                <div>
                ...
                <div className="flex items-center justify-between mt-3">
                    <div className="flex items-center gap-2">
                       <Avatar src="https://i.pravatar.cc/150?u=3" size="xs" className="w-5 h-5" />
             ...
             {/* Best Deal */}
             <div className="bg-black text-white rounded-2xl p-4 w-40 flex flex-col justify-between relative overflow-hidden cursor-pointer group-hover:scale-[1.02] transition-transform">
                <div>
                ...
                <div className="flex items-center justify-between mt-3">
                    <span className="text-xs font-medium text-gray-300">Rolf Inc.</span>
